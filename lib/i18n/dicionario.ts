...
export const DICIONARIO: Traducoes = {
  ...
  "Buscar por nome, setor ou cidade...": { es: "Buscar por nombre, sector o ciudad..." },
  "Nenhuma empresa cliente cadastrada": { es: "No hay empresas clientes registradas" },
  "Cadastre as empresas parceiras e contratantes para vincular contatos corporativos e vagas de recrutamento.": { es: "Registra las empresas asociadas y contratantes para vincular contactos corporativos y vacantes de reclutamiento." },
  "Cadastrar Primeira Empresa": { es: "Registrar primera empresa" },
  "Empresa": { es: "Empresa" },
  "Setor": { es: "Sector" },
  "Localização": { es: "Ubicación" },
  "Website": { es: "Sitio web" },
  "Prospect": { es: "Prospecto" },
  "empresas": { es: "empresas" },
  "Empresa cliente criada com sucesso!": { es: "¡Empresa cliente creada con éxito!" },
  "Nova Empresa Cliente": { es: "Nueva empresa cliente" },
  "Cadastre os dados principais da empresa contratante.": { es: "Registra los datos principales de la empresa contratante." },
  "Nome Fantasia": { es: "Nombre comercial" },
  "ex: Tramontina": { es: "ej.: Tramontina" },
  "Razão Social": { es: "Razón social" },
  "ex: Tramontina S.A.": { es: "ej.: Tramontina S.A." },
  "Setor de Atuação": { es: "Sector de actividad" },
  "ex: Indústria, Varejo": { es: "ej.: Industria, Comercio minorista" },
  "ex: www.empresa.com.br": { es: "ej.: www.empresa.com" },
  "Cidade": { es: "Ciudad" },
  "ex: Recife": { es: "ej.: Recife" },
  "Estado (UF)": { es: "Estado (UF)" },
  "ex: PE": { es: "ej.: PE" },
  "Criar Empresa": { es: "Crear empresa" },
  "Visão consolidada de todas as inscrições e movimentações do funil de R&S.": { es: "Vista consolidada de todas las postulaciones y movimientos del embudo de selección." },
  "Abrir Pipeline Kanban": { es: "Abrir pipeline Kanban" },
  "Filtrar por vaga": { es: "Filtrar por vacante" },
  "Todas as vagas": { es: "Todas las vacantes" },
  "Filtrar por etapa": { es: "Filtrar por etapa" },
  "Todas as etapas": { es: "Todas las etapas" },
  "Nenhuma candidatura encontrada": { es: "No se encontraron postulaciones" },
  "Vincule talentos a vagas abertas para começar a acompanhar as etapas do processo seletivo.": { es: "Vincula talentos a vacantes abiertas para comenzar a seguir las etapas del proceso de selección." },
  "Ir para Vagas": { es: "Ir a Vacantes" },
  "Candidato": { es: "Candidato" },
  "Vaga": { es: "Vacante" },
  "Empresa Cliente": { es: "Empresa cliente" },
  "Etapa Atual": { es: "Etapa actual" },
  "Data": { es: "Fecha" },
  "Pipeline": { es: "Pipeline" },
  "Dossiê": { es: "Expediente" },
  "candidaturas": { es: "postulaciones" },
  "Erro ao obter link para download do currículo.": { es: "Error al obtener el enlace de descarga del currículum." },
  "Currículos Recebidos": { es: "Currículos recibidos" },
  "Repositório seguro e versionado de arquivos de currículo (PDF/DOCX).": { es: "Repositorio seguro y versionado de archivos de currículum (PDF/DOCX)." },
  "Nenhum currículo armazenado": { es: "No hay currículos almacenados" },
  "Os currículos são vinculados diretamente aos candidatos através da página do Banco de Talentos.": { es: "Los currículos se vinculan directamente a los candidatos desde la página del Banco de Talentos." },
  "Ir para Banco de Talentos": { es: "Ir al Banco de Talentos" },
  "Arquivo": { es: "Archivo" },
  "Tamanho": { es: "Tamaño" },
  "Ver Dossiê": { es: "Ver expediente" },
  "Atual": { es: "Actual" },
  "Download": { es: "Descargar" },
  "Banco de talentos, vagas, candidaturas e pipeline seletivo.": { es: "Banco de talentos, vacantes, postulaciones y pipeline de selección." },
  "Candidatura movida para": { es: "Postulación movida a" },
  "Não foi possível mover a candidatura.": { es: "No se pudo mover la postulación." },
  "Pipeline R&S": { es: "Pipeline de selección" },
  "Funil de 10 etapas para triagem, avaliação e aprovação de candidatos.": { es: "Embudo de 10 etapas para selección, evaluación y aprobación de candidatos." },
  "Filtrar por vaga...": { es: "Filtrar por vacante..." },
  "Todas as vagas ativas": { es: "Todas las vacantes activas" },
  "Abrir Dossiê": { es: "Abrir expediente" },
  "Sem cargo": { es: "Sin cargo" },
  "Carregando funil de seleção...": { es: "Cargando embudo de selección..." },
  "Candidato não encontrado.": { es: "Candidato no encontrado." },
  "Voltar ao Banco de Talentos": { es: "Volver al Banco de Talentos" },
  "Currículo anexado com sucesso!": { es: "¡Currículum adjuntado con éxito!" },
  "Sem cargo informado": { es: "Sin cargo informado" },
  "Informações Profissionais": { es: "Información profesional" },
  "Área": { es: "Área" },
  "Senioridade": { es: "Nivel profesional" },
  "Pretensão Salarial": { es: "Pretensión salarial" },
  "Disponibilidade": { es: "Disponibilidad" },
  "Contatos e Links": { es: "Contactos y enlaces" },
  "Perfil no LinkedIn": { es: "Perfil en LinkedIn" },
  "Currículos Anexados": { es: "Currículos adjuntos" },
  "Anexar Currículo": { es: "Adjuntar currículum" },
  "Nenhum currículo anexado para este candidato.": { es: "No hay currículos adjuntos para este candidato." },
  "Processos Seletivos": { es: "Procesos de selección" },
  "Candidato ainda não foi vinculado a nenhuma vaga aberta.": { es: "El candidato aún no está vinculado a ninguna vacante abierta." },
  "Vaga vinculada": { es: "Vacante vinculada" },
  "Ver no Pipeline": { es: "Ver en el pipeline" },
  "Repositório central de candidatos profissionais e executivos.": { es: "Repositorio central de candidatos profesionales y ejecutivos." },
  "Novo Candidato": { es: "Nuevo candidato" },
  "Buscar por nome, cargo ou empresa...": { es: "Buscar por nombre, cargo o empresa..." },
  "Em Processo": { es: "En proceso" },
  "Contratado": { es: "Contratado" },
  "Não Contatar": { es: "No contactar" },
  "Todas as senioridades": { es: "Todos los niveles profesionales" },
  "Júnior": { es: "Júnior" },
  "Pleno": { es: "Intermedio" },
  "Sênior": { es: "Sénior" },
  "Especialista": { es: "Especialista" },
  "Coordenação": { es: "Coordinación" },
  "Gerência": { es: "Gerencia" },
  "Diretoria / C-Level": { es: "Dirección / C-Level" },
  "Nenhum candidato encontrado": { es: "No se encontraron candidatos" },
  "Cadastre novos profissionais no banco de talentos para vinculá-los aos processos seletivos.": { es: "Registra nuevos profesionales en el banco de talentos para vincularlos a los procesos de selección." },
  "Cadastrar Primeiro Candidato": { es: "Registrar primer candidato" },
  "Cargo / Empresa": { es: "Cargo / Empresa" },
  "candidatos": { es: "candidatos" },
  "Candidato cadastrado com sucesso!": { es: "¡Candidato registrado con éxito!" },
  "Cadastre as informações profissionais do talento.": { es: "Registra la información profesional del talento." },
  "Nome Completo": { es: "Nombre completo" },
  "ex: Carlos Eduardo Silva": { es: "ej.: Carlos Eduardo Silva" },
  "ex: carlos@email.com": { es: "ej.: carlos@email.com" },
  "Telefone / WhatsApp": { es: "Teléfono / WhatsApp" },
  "ex: (81) 98888-7777": { es: "ej.: (81) 98888-7777" },
  "Cargo Atual": { es: "Cargo actual" },
  "ex: Gerente de Operações": { es: "ej.: Gerente de Operaciones" },
  "Empresa Atual": { es: "Empresa actual" },
  ...
  "https://linkedin.com/in/perfil": { es: "https://linkedin.com/in/perfil" },
  "Cadastrar Candidato": { es: "Registrar candidato" },
  "Vaga não encontrada.": { es: "Vacante no encontrada." },
  "Voltar às Vagas": { es: "Volver a Vacantes" },
  "Abrir Pipeline R&S": { es: "Abrir pipeline de selección" },
  "Adicionar Candidato": { es: "Añadir candidato" },
  "Descrição da Vaga": { es: "Descripción de la vacante" },
  "Nenhuma descrição cadastrada.": { es: "No hay descripción registrada." },
  "Requisitos e Qualificações": { es: "Requisitos y calificaciones" },
  "Candidaturas Inscritas": { es: "Postulaciones registradas" },
  "candidato": { es: "candidato" },
  "Nenhum candidato vinculado a esta vaga ainda.": { es: "Aún no hay candidatos vinculados a esta vacante." },
  "Detalhes da Posição": { es: "Detalles del puesto" },
  "Departamento": { es: "Departamento" },
  "Modelo de Trabalho": { es: "Modalidad de trabajo" },
  "Vagas Abertas": { es: "Vacantes abiertas" },
  "Data de Abertura": { es: "Fecha de apertura" },
  "Selecione um candidato.": { es: "Selecciona un candidato." },
  "Candidato vinculado à vaga!": { es: "¡Candidato vinculado a la vacante!" },
  "Adicionar Candidato à Vaga": { es: "Añadir candidato a la vacante" },
  "Selecione um profissional cadastrado no banco de talentos.": { es: "Selecciona un profesional registrado en el banco de talentos." },
  "Selecione um talento...": { es: "Selecciona un talento..." },
  "Adicionando...": { es: "Añadiendo..." },
  "Vincular à Vaga": { es: "Vincular a la vacante" },
  "Vagas de Recrutamento": { es: "Vacantes de reclutamiento" },
  "Gestão de posições abertas e processos seletivos para empresas clientes.": { es: "Gestión de puestos abiertos y procesos de selección para empresas clientes." },
  "Nova Vaga": { es: "Nueva vacante" },
  "Buscar por título ou departamento...": { es: "Buscar por título o departamento..." },
  "Nenhuma vaga aberta": { es: "No hay vacantes abiertas" },
  "Abra novas vagas vinculadas às empresas clientes para dar início ao processo de atração e seleção.": { es: "Abre nuevas vacantes vinculadas a empresas clientes para iniciar el proceso de atracción y selección." },
  "Abrir Primeira Vaga": { es: "Abrir primera vacante" },
  "Título da Vaga": { es: "Título de la vacante" },
  "Local": { es: "Ubicación" },
  "Remoto": { es: "Remoto" },
  "Híbrido": { es: "Híbrido" },
  "Selecione uma empresa cliente": { es: "Selecciona una empresa cliente" },
  "Vaga aberta com sucesso!": { es: "¡Vacante abierta con éxito!" },
  "Nova Vaga de Recrutamento": { es: "Nueva vacante de reclutamiento" },
  "Abra uma nova posição vinculada a um cliente B2B.": { es: "Abre un nuevo puesto vinculado a un cliente B2B." },
  "ex: Diretor de Operações Industriais": { es: "ej.: Director de Operaciones Industriales" },
  "Selecione a empresa contratante...": { es: "Selecciona la empresa contratante..." },
  "ex: Diretoria / Operações": { es: "ej.: Dirección / Operaciones" },
  "Descrição do Perfil": { es: "Descripción del perfil" },
  "Resumo da missão da vaga...": { es: "Resumen de la misión del puesto..." },
  "Publicar Vaga": { es: "Publicar vacante" },
  "Abrir Funil de Seleção": { es: "Abrir embudo de selección" },
  "Editar Candidato": { es: "Editar candidato" },
  "Candidato atualizado com sucesso!": { es: "¡Candidato actualizado con éxito!" },
  "Atualize as informações do profissional.": { es: "Actualiza la información del profesional." },
  "Salvar Alterações": { es: "Guardar cambios" },
  "Editar Vaga": { es: "Editar vacante" },
  "Vaga atualizada com sucesso!": { es: "¡Vacante actualizada con éxito!" },
  "Atualize as informações da vaga de recrutamento.": { es: "Actualiza la información de la vacante de reclutamiento." },
  "Editar Empresa": { es: "Editar empresa" },
  "Empresa atualizada com sucesso!": { es: "¡Empresa actualizada con éxito!" },
  "Atualize os dados da empresa contratante.": { es: "Actualiza los dados de la empresa contratante." },
  "Observações": { es: "Observaciones" },
  "Tipo de Contratação": { es: "Tipo de contratación" },
  "Quantidade de Vagas": { es: "Cantidad de vacantes" },
  "Salário Mínimo (R$)": { es: "Salario mínimo (R$)" },
  "Salário Máximo (R$)": { es: "Salario máximo (R$)" },
  "CLT": { es: "CLT" },
  "PJ": { es: "PJ" },
  "Estágio": { es: "Pasantía" },
  "Temporário": { es: "Temporal" },
  ...
  // -------------------------------------------------------------------------
  // B2B CRM / Agenda / Recrutamento — telas que já tinham t() mas ainda não
  // tinham a coluna es. Sem estas entradas a escolha do idioma caía de volta
  // para o português exatamente nas superfícies adicionadas na 4.3B.
  "Título do compromisso": { es: "Título de la cita" },
  "Reunião com Decisor": { es: "Reunión con decisor" },
  Modalidade: { es: "Modalidad" },
  "Online (Meet / Zoom / Teams)": { es: "En línea (Meet / Zoom / Teams)" },
  "Local ou Link": { es: "Lugar o enlace" },
  "Observações / Pauta": { es: "Observaciones / Agenda" },
  "Pauta do encontro, contexto e alinhamentos prévios...": {
    es: "Agenda de la reunión, contexto y acuerdos previos...",
  },
  "Google Calendar não conectado": { es: "Google Calendar no conectado" },
  "A sincronização de agenda está inativa no momento.": {
    es: "La sincronización del calendario está inactiva en este momento.",
  },
  "Contato Principal": { es: "Contacto principal" },
  "Empresa vinculada": { es: "Empresa vinculada" },
  "Cargo / Função": { es: "Cargo / Función" },
  "Busque, filtre e gerencie contatos corporativos e profissionais.": {
    es: "Busca, filtra y gestiona contactos corporativos y profesionales.",
  },
  "Empresa cliente não encontrada.": { es: "Empresa cliente no encontrada." },
  "Voltar às Empresas": { es: "Volver a Empresas" },
  "Conta Corporativa": { es: "Cuenta corporativa" },
  "Dados da Empresa": { es: "Datos de la empresa" },
  "Cidade / UF": { es: "Ciudad / Estado" },
  "Status Comercial": { es: "Estado comercial" },
  "Cadastrada em": { es: "Registrada el" },
  "Observações Comerciais & Alinhamentos": { es: "Observaciones comerciales y acuerdos" },
  "Nenhuma observação cadastrada para esta empresa.": {
    es: "No hay observaciones registradas para esta empresa.",
  },
  "Oportunidades Comerciais": { es: "Oportunidades comerciales" },
  "Negócios e projetos comerciais vinculados a esta conta": {
    es: "Negocios y proyectos comerciales vinculados a esta cuenta",
  },
  oportunidades: { es: "oportunidades" },
  "Nenhuma oportunidade comercial vinculada": { es: "Ninguna oportunidad comercial vinculada" },
  "Crie uma oportunidade no Funil Comercial associando esta empresa cliente.": {
    es: "Crea una oportunidad en el embudo comercial asociando esta empresa cliente.",
  },
  "Ver no Funil": { es: "Ver en el embudo" },
  "Vagas & Processos de R&S": { es: "Vacantes y procesos de selección" },
  "Nenhuma vaga vinculada": { es: "Ninguna vacante vinculada" },
  "Esta empresa cliente ainda não possui processos seletivos cadastrados no módulo de Recrutamento & Seleção.": {
    es: "Esta empresa cliente todavía no tiene procesos de selección registrados en el módulo de Reclutamiento y Selección.",
  },
  posições: { es: "posiciones" },
  "Ver Vaga": { es: "Ver vacante" },
  "Contatos & Decisores": { es: "Contactos y decisores" },
  "Decisores vinculados via CRM comercial.": {
    es: "Decisores vinculados mediante el CRM comercial.",
  },
  "Nenhum contato vinculado": { es: "Ningún contacto vinculado" },
  "Não há decisores corporativos associados a esta empresa.": {
    es: "No hay decisores corporativos asociados a esta empresa.",
  },
  Principal: { es: "Principal" },
  "Sem dados de contato direto.": { es: "Sin datos de contacto directo." },
  "Ver empresa": { es: "Ver empresa" },
  "Em breve": { es: "Próximamente" },
  "Funil Comercial": { es: "Embudo comercial" },
  oportunidade: { es: "oportunidad" },
  "oportunidade aberta": { es: "oportunidad abierta" },
  "oportunidades abertas": { es: "oportunidades abiertas" },
  "Nenhuma oportunidade ativa no funil comercial.": {
    es: "No hay oportunidades activas en el embudo comercial.",
  },
  "Nova Oportunidade": { es: "Nueva oportunidad" },
  "Nome Completo *": { es: "Nombre completo *" },
  "Quantidade de Posições": { es: "Cantidad de posiciones" },
  Oportunidade: { es: "Oportunidad" },
  "Negócio ativo": { es: "Negocio activo" },
  "Contexto B2B": { es: "Contexto B2B" },
  "Oportunidade comercial (opcional)": { es: "Oportunidad comercial (opcional)" },
  "Selecione uma oportunidade...": { es: "Selecciona una oportunidad..." },
  "Nenhuma oportunidade": { es: "Ninguna oportunidad" },
  "Empresa cliente": { es: "Empresa cliente" },
  "Selecione a empresa...": { es: "Selecciona la empresa..." },
  "Nenhuma empresa": { es: "Ninguna empresa" },
  "Empresa sem nome": { es: "Empresa sin nombre" },
  "Decisor / Contato": { es: "Decisor / Contacto" },
  "Empresa sem contatos": { es: "Empresa sin contactos" },
  "Selecione o decisor...": { es: "Selecciona el decisor..." },
  "Responsável pela tarefa": { es: "Responsable de la tarea" },
  "Atribuir a um membro...": { es: "Asignar a un miembro..." },
  "Sem responsável atribuído": { es: "Sin responsable asignado" },
  "O que precisa ser feito *": { es: "Qué hay que hacer *" },
  "Ex.: Fazer follow-up com Empresa Teste Vértice": {
    es: "Ej.: Hacer seguimiento con Empresa Prueba Vértice",
  },
  "Ver Empresa": { es: "Ver empresa" },
  "Ver Oportunidade no Funil": { es: "Ver oportunidad en el embudo" },
  "Ver Contato": { es: "Ver contacto" },
  "Digite para buscar...": { es: "Escribe para buscar..." },
  "Empresa:": { es: "Empresa:" },
  "Oportunidade relacionada (opcional)": { es: "Oportunidad relacionada (opcional)" },
  "Sem oportunidade vinculada": { es: "Sin oportunidad vinculada" },
  "Iniciar conversa": { es: "Iniciar conversación" },
  "Selecione uma empresa": { es: "Selecciona una empresa" },
  "Nenhuma empresa (desvincular)": { es: "Ninguna empresa (desvincular)" },
  "ex: Diretor de RH, Gerente de Pessoas, CEO": {
    es: "ej.: Director de RR. HH., Gerente de Personas, CEO",
  },
  "Marcar como decisor principal desta empresa": {
    es: "Marcar como decisor principal de esta empresa",
  },
  "Empresa (opcional)": { es: "Empresa (opcional)" },
  "Oportunidade atualizada": { es: "Oportunidad actualizada" },
  "Editar oportunidade": { es: "Editar oportunidad" },
  "Título da Oportunidade": { es: "Título de la oportunidad" },
  "Selecione a empresa cliente": { es: "Selecciona la empresa cliente" },
  "Selecione a empresa primeiro": { es: "Selecciona primero la empresa" },
  "Nenhum decisor cadastrado": { es: "Ningún decisor registrado" },
  "Selecione o decisor": { es: "Selecciona el decisor" },
  "Sem decisor definido": { es: "Sin decisor definido" },
  "Selecione uma empresa cliente.": { es: "Selecciona una empresa cliente." },
  "Oportunidade criada": { es: "Oportunidad creada" },
  "Crie uma oportunidade comercial B2B vinculada a uma empresa cliente.": {
    es: "Crea una oportunidad comercial B2B vinculada a una empresa cliente.",
  },
  "Título da Oportunidade *": { es: "Título de la oportunidad *" },
  "Empresa Cliente *": { es: "Empresa cliente *" },
  "Decisor / Contato Comercial (Opcional)": { es: "Decisor / Contacto comercial (opcional)" },
  "Nenhum decisor cadastrado nesta empresa": { es: "Ningún decisor registrado en esta empresa" },
  "Selecione um decisor (opcional)": { es: "Selecciona un decisor (opcional)" },
  "Selecione o responsável (opcional)": { es: "Selecciona al responsable (opcional)" },
  "Descrição / Escopo": { es: "Descripción / Alcance" },
  "Contexto da negociação, perfil das vagas, observações…": {
    es: "Contexto de la negociación, perfil de las vacantes, observaciones…",
  },
  "Etapa do Funil": { es: "Etapa del embudo" },
  "Valor Estimado (R$)": { es: "Valor estimado (R$)" },
  "Criar oportunidade": { es: "Crear oportunidad" },

  // Dashboard executivo e identidade da instalação.
  "Painel Executivo & Operacional": { es: "Panel ejecutivo y operativo" },
  "Novo Contato": { es: "Nuevo contacto" },
  "Nova Tarefa": { es: "Nueva tarea" },
  "Olá,": { es: "Hola," },
  "! Visão unificada do seu dia, funil comercial e recrutamento executivo.": {
    es: "! Vista unificada de tu día, embudo comercial y reclutamiento ejecutivo.",
  },
  "Hoje na Operação": { es: "Hoy en la operación" },
  "Compromissos de Hoje": { es: "Citas de hoy" },
  ...
  "Oportunidades Abertas": { es: "Oportunidades abiertas" },
  "Em negociação ativa": { es: "En negociación activa" },
  "Valor Estimado no Funil": { es: "Valor estimado en el embudo" },
  "Soma dos valores em aberto": { es: "Suma de los valores abiertos" },
  "Paradas / Em Risco": { es: "Detenidas / en riesgo" },
  "> 7 dias sem interação": { es: "> 7 días sin interacción" },
  "Oportunidades Recentes": { es: "Oportunidades recientes" },
  "Nenhuma oportunidade comercial aberta.": { es: "No hay oportunidades comerciales abiertas." },
  "Recrutamento & Seleção Executiva": { es: "Reclutamiento y selección ejecutiva" },
  "Ver Hub de Recrutamento": { es: "Ver hub de reclutamiento" },
  "Posições em andamento": { es: "Posiciones en curso" },
  "Candidatos no Processo": { es: "Candidatos en el proceso" },
  "Talentos ativos ou em triagem": { es: "Talentos activos o en selección" },
  "Ver todas": { es: "Ver todas" },
  "Nenhuma vaga aberta no momento.": { es: "No hay vacantes abiertas en este momento." },
  "Candidaturas Recentes": { es: "Postulaciones recientes" },
  "Ver Funil": { es: "Ver embudo" },
  "Nenhuma candidatura registrada.": { es: "No hay postulaciones registradas." },
  "ex: Grupo Vértice": { es: "ej.: Grupo Vértice" },
  "Informações relevantes sobre perfil e entrevistas": {
    es: "Información relevante sobre el perfil y las entrevistas",
  },
  "Vértice Hub": { es: "Vértice Hub" },
  "Pessoas & Estratégia": { es: "Personas y estrategia" },
};
